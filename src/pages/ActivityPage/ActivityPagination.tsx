...
import { getActivityPaginationItems } from "./activity.utils";
...
export function ActivityPagination({ data, onPageChange }: ActivityPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
      ...
      <div className="flex items-center gap-1">
        ...
        {getActivityPaginationItems(data.page, data.totalPages).map((item, index) =>
          item === "..." ? (
